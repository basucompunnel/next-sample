...
export default function ContactSalesButton({ isVisible }: { isVisible: boolean }) {
  return (
    <button 
      className={`w-full sm:w-auto rounded-lg border border-gray-700 bg-gray-900 px-6 py-2.5 text-sm sm:text-base font-medium text-white transition-all duration-300 hover:bg-gray-800 hover:border-white/20 hover:scale-105 hover:shadow-[0_0_20px_rgba(255,255,255,0.1)] cursor-pointer ${
        isVisible 
