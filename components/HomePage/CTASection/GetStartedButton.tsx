...
export default function GetStartedButton({ isVisible }: { isVisible: boolean }) {
  return (
    <button 
      className={`w-full sm:w-auto rounded-lg bg-white px-6 py-2.5 text-sm sm:text-base font-medium text-black transition-all duration-300 hover:bg-gray-200 hover:scale-105 hover:shadow-[0_4px_12px_rgba(255,255,255,0.15)] hover:-translate-y-0.5 cursor-pointer ${
        isVisible 
