...
/**
 * Individual feature card with cascading animations and hover effects
 ...
 * - Hover effects: icon scales 125% and rotates 12° with purple color, text changes to lighter shades
 * - Gradient underline expands from 0 to full width on hover (purple to pink gradient)
 * - Purple/pink theme differentiates from other sections
 * @param feature - Feature object with icon, title, and description
